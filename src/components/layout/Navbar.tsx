...
export function Navbar() {
  ...
  return (
    <>
      ...
      {/* Rendered as a sibling, not a header descendant: the header gets
          backdrop-filter (the "glass" class) once scrolled, and an ancestor
          with backdrop-filter becomes the containing block for `fixed`
          descendants — which would clamp this full-screen panel to the
          header's own ~70px box instead of the viewport. */}
